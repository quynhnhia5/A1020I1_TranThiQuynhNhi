...
public class UserDAO  implements IUserDAO{
  ...
  private String jdbcPassword = "nhinhi171";
...
//      psUpdate.setBigDecimal(2, new BigDecimal(999.99));
  ...
  public void editUserStore(int id, String name, String email, String country) {
    ...
    try (Connection conn = getConnection();
      ...
      int rowEffect = callableStatement.executeUpdate();
      System.out.println("Edited " + rowEffect + " record.");
    } catch (SQLException e) {
      printSQLException(e);
    }
  }
  ...
  public void deleteUserStore(int id) {
    ...
    try (Connection conn = getConnection();
      ...
      int del = callableStatement.executeUpdate();
      System.out.println("Deleted " + del + " record.");
    } catch (SQLException e) {
      printSQLException(e);
    }
  }
