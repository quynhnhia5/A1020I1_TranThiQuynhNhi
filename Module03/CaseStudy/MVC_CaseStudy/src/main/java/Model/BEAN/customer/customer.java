...
public class customer {
  ...
  public customer(Model.BEAN.customer.customerType customerType, String customer_name, Date customer_birthday, boolean customer_gender, String customer_is_card, String customer_phone, String customer_email, String customer_address) {
  ...
  public customer(int customer_id, Model.BEAN.customer.customerType customerType, String customer_name, Date customer_birthday, boolean customer_gender, String customer_is_card, String customer_phone, String customer_email, String customer_address) {
