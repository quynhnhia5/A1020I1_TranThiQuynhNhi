...
//    public static int AuthorizationMember(HttpServletRequest request, Connection conn, user  user) {
//        PreparedStatement ptmt=null;
//
//
//        String sql="select categorymemberid from member where membername='"+user.getMembername()+"'AND memberpass='"+member.getMemberpass()+"'";
