...
--
-- Host: localhost    Database: car_shop_management
-- ------------------------------------------------------
...
CREATE TABLE `orderdetail` (
  ...
  CONSTRAINT `orderdetail_ibfk_1` FOREIGN KEY (`orderNumber`) REFERENCES `order` (`orderNumber`),
...
-- Dump completed on 2021-09-14 17:41:15
